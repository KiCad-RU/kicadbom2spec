...
###########################################################################
## Python code generated with wxFormBuilder (version 3.9.0 May  6 2021)
...
class MainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.menu_file.Append( self.menuitem_open_sch )
        ...
        self.menu_file.Append( self.menuitem_save_sch )
        ...
        self.menu_file.Append( self.menuitem_save_sch_as )
        ...
        self.menu_file.Append( self.menuitem_open_lib )
        ...
        self.menu_file.Append( self.menuitem_save_lib )
        ...
        self.menu_file.Append( self.menuitem_save_lib_as )
        ...
        self.menu_file.Append( self.menuitem_complist )
        ...
        self.menu_edit.Append( self.menuitem_edit )
        ...
        self.menu_edit.Append( self.menuitem_clear )
        ...
        self.menu_edit.Append( self.menuItem_settings )
        ...
        self.menu_edit.Append( self.menuItem_settings_import )
        ...
        self.menu_edit.Append( self.menuItem_settings_export )
        ...
        self.menu_view.Append( self.menuitem_tool )
        ...
        self.menu_view.Append( self.menuitem_comp_fields_panel )
        ...
        self.menu_help.Append( self.menuitem_help )
        ...
        self.tool_open_sch = self.toolbar.AddTool( ID_OPEN_SCH, u"Открыть схему", wx.Bitmap( u"bitmaps/document-open.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Открыть файл схемы", wx.EmptyString, None )

        self.tool_save_sch = self.toolbar.AddTool( ID_SAVE_SCH, u"Сохранить схему", wx.Bitmap( u"bitmaps/document-save.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Сохранить изменения пользовательских полей в файл схемы", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_complist = self.toolbar.AddTool( ID_COMPLIST, u"Создать перечень элементов", wx.Bitmap( u"bitmaps/document-export.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Создать перечень элементов", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_copy = self.toolbar.AddTool( ID_COPY, u"Копировать", wx.Bitmap( u"bitmaps/edit-copy.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Копировать поля", wx.EmptyString, None )

        self.tool_cut = self.toolbar.AddTool( ID_CUT, u"Вырезать", wx.Bitmap( u"bitmaps/edit-cut.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Вырезать поля", wx.EmptyString, None )

        self.tool_paste = self.toolbar.AddTool( ID_PASTE, u"Вставить", wx.Bitmap( u"bitmaps/edit-paste.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Вставить поля", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_undo = self.toolbar.AddTool( ID_UNDO, u"Отменить", wx.Bitmap( u"bitmaps/edit-undo.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Отменить последнее действие", wx.EmptyString, None )

        self.tool_redo = self.toolbar.AddTool( ID_REDO, u"Повторить", wx.Bitmap( u"bitmaps/edit-redo.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Повторить предыдущее действие", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_edit = self.toolbar.AddTool( ID_EDIT, u"Редактировать", wx.Bitmap( u"bitmaps/gtk-edit.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Редактировать поля", wx.EmptyString, None )

        self.tool_clear = self.toolbar.AddTool( ID_CLEAR, u"Очистить", wx.Bitmap( u"bitmaps/edit-clear.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Очистить пользовательские поля", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_find = self.toolbar.AddTool( ID_FIND, u"Найти", wx.Bitmap( u"bitmaps/edit-find.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Найти текст", wx.EmptyString, None )

        self.tool_replace = self.toolbar.AddTool( ID_REPLACE, u"Заменить", wx.Bitmap( u"bitmaps/edit-find-replace.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Заменить текст", wx.EmptyString, None )

        self.toolbar.AddSeparator()

        self.tool_help = self.toolbar.AddTool( ID_HELP, u"Справка", wx.Bitmap( u"bitmaps/help-contents.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"Открыть справку", wx.EmptyString, None )

        self.tool_comp_fields_panel = self.toolbar.AddTool( ID_COMP_FIELDS_PANEL, u"Панель полей компонента", wx.Bitmap( u"bitmaps/properties-panel.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_CHECK, u"Показать или скрыть панель полей выбранного компонента", wx.EmptyString, None )
        ...
        self.panel_components = wx.Panel( self.splitter_main, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL|wx.BORDER_RAISED )
        self.panel_comp_fields = wx.Panel( self.splitter_main, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL|wx.BORDER_RAISED )
        ...
        self.comp_fields_panel_grid.SetColLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )

        # Rows
        self.comp_fields_panel_grid.EnableDragRowSize( False )
        self.comp_fields_panel_grid.SetRowLabelSize( 50 )
        self.comp_fields_panel_grid.SetRowLabelAlignment( wx.ALIGN_CENTER, wx.ALIGN_CENTER )
...
class AboutDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"О программе", pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.CAPTION )
        ...
        sizer_about.Add( ( 0, 0), 1, wx.EXPAND, 5 )

        sizer_author_email = wx.BoxSizer( wx.HORIZONTAL )

        self.statictext_author = wx.StaticText( self.panel_about_dialog, wx.ID_ANY, u"Автор:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.statictext_author.Wrap( -1 )

        sizer_author_email.Add( self.statictext_author, 0, wx.ALIGN_CENTER_VERTICAL|wx.RIGHT|wx.LEFT, 5 )

        self.hyperlink_email = wx.adv.HyperlinkCtrl( self.panel_about_dialog, wx.ID_ANY, u"Барановский Константин", u"mailto:baranovskiykonstantin@gmail.com?subject=kicadbom2spec", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
        sizer_author_email.Add( self.hyperlink_email, 0, wx.RIGHT|wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5 )


        sizer_about.Add( sizer_author_email, 0, wx.EXPAND, 5 )

        sizer_author2_email = wx.BoxSizer( wx.HORIZONTAL )

        self.statictext_author2 = wx.StaticText( self.panel_about_dialog, wx.ID_ANY, u"Участник:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.statictext_author2.Wrap( -1 )

        sizer_author2_email.Add( self.statictext_author2, 0, wx.ALIGN_CENTER_VERTICAL|wx.RIGHT|wx.LEFT, 5 )

        self.hyperlink_email2 = wx.adv.HyperlinkCtrl( self.panel_about_dialog, wx.ID_ANY, u"Хайруллин Эльдар", u"mailto:eldar.khayrullin@mail.ru?subject=kicadbom2spec", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
        sizer_author2_email.Add( self.hyperlink_email2, 0, wx.RIGHT|wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5 )


        sizer_about.Add( sizer_author2_email, 1, wx.EXPAND, 5 )
        ...
        self.hyperlink_homepage = wx.adv.HyperlinkCtrl( self.panel_about_dialog, wx.ID_ANY, u"https://github.com/KiCad-RU/kicadbom2spec", u"https://github.com/KiCad-RU/kicadbom2spec", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
...
class CompListDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.checkbox_all_components.SetToolTip( u"Если данная функция включена, в перечень элементов будут включены все элементы, не зависимо от того установлен флажок для элемента или нет." )
        ...
        self.checkbox_add_units.SetToolTip( u"Если для резисторов, конденсаторов или индуктивностей указаны только значения и данная опция включена, то к значениям будут добавлены соответствующие единицы измерения (Ом, Ф, Гн)." )
        ...
        sizer_space_before_units.Add( ( 20, 0), 0, wx.ALIGN_CENTER_VERTICAL, 5 )
        ...
        self.checkbox_space_before_units.SetToolTip( u"Если данная опция включена, то между цифровой частью значения и единицами измерения (включая множитель) будет вставлен пробел." )
        ...
        self.checkbox_empty_row_after_name.SetToolTip( u"Если параметр отмечен, то между наименованием группы и первым её элементом будет вставлена одна пустая строка." )
        ...
        self.empty_rows_groups_label.SetToolTip( u"Между группами элементов с разным обозначением будет вставлено указанное число пустых строк." )
        ...
        self.checkbox_empty_rows_everywhere.SetToolTip( u"Если параметр отмечен, то пустые строки будут вставлены не только между разными типами элементов, но и между элементами, которые имеют разное наименование группы." )
        ...
        self.checkbox_prohibit_empty_rows_on_top.SetToolTip( u"Если при вставке пустых строк выполняется переход на новую страницу и этот параметр активен, то оставшиеся пустые строки опускаются и страница начинается со следующей группы элементов." )
        ...
        self.checkbox_gost_in_group_name.SetToolTip( u"Если параметр отмечен, то для каждой марки компонентов, стандарт будет указан в заголовке группы, а не в строке компонента." )
        ...
        self.checkbox_singular_group_name.SetToolTip( u"По умолчанию, для каждой группы наименование указывается в виде заголовка на отдельной строке.\nЕсли параметр отмечен, то наименование группы состоящей из одного элемента будет указано в наименовании этого элемента, а не отдельно." )
        ...
        self.checkbox_prohibit_group_name_at_bottom.SetToolTip( u"Если, при заполнении перечня, внизу страницы оказывается наименование группы без элементов, то с помощью этого параметра можно указать программе переносить его на следующую страницу, к эелементам." )
        ...
        self.checkbox_first_usage.SetToolTip( u"Если данная опция включена, то форматная рамка будет содержать графы первичной применяемости (24, 25 по ГОСТ2.104-2006)" )
        ...
        sizer_first_usage.Add( ( 20, 0), 0, wx.ALIGN_CENTER_VERTICAL, 5 )
        ...
        self.checkbox_first_usage_fill.SetToolTip( u"Если данная опция включена, то графа Перв. примен. будет заполнена значением децимального номера без кода документа" )
        ...
        self.checkbox_customer_fields.SetToolTip( u"Если данная опция включена, то над основной надписью будут показаны графы заказчика (27-30 по ГОСТ2.104-2006)" )
        ...
        self.checkbox_changes_sheet.SetToolTip( u"Если данная опция включена и количество листов перечня превышает указанное число, то в конец перечня элементов будет добавлен лист регистрации изменений." )
        ...
        sizer_first_count_for_changes_sheet.Add( ( 25, 0), 0, wx.ALIGN_CENTER_VERTICAL, 5 )
        ...
        self.checkbox_italic.SetToolTip( u"Использовать курсив для оформления перечня элементов.\nЕсли отметка отсутствует, будет использован прямой шрифт." )
        ...
        self.checkbox_underline_group.SetToolTip( u"Если параметр отмечен, то наименование группы элементов будет подчёркнуто сплошной линией." )
        ...
        self.checkbox_center_group.SetToolTip( u"Если параметр отмечен, то наименования групп элементов будут выравнены по центру ячейки таблицы, а не по её левому краю." )
        ...
        self.checkbox_center_ref.SetToolTip( u"Если параметр отмечен, то позиционные обозначения элементов будут выровнены по центру ячейки таблицы, а не по её левому краю." )
        ...
        self.statictext_extremal_width_factor.SetToolTip( u"Если содержимое ячейки слишком велико и не помещается, ширина шрифта уменьшается до необходимой величины. Данный параметр позволяет избежать чрезмерного сжатия, текст разбивается на слова и переносится на следующую строку." )
        ...
        self.checkbox_open.SetToolTip( u"Если этот параметр установлен, то после создания перечня элементов он будет открыт в редакторе по умолчанию." )
        ...
        sizer_options.Add( ( 0, 0), 1, wx.EXPAND, 5 )
        ...
        self.stamp_title_converted.SetToolTip( u"Наименование автоматически корректируется\nсогласно ЕСКД.\nДанное значение будет указано в основной надписи\nперечня элементов." )
        ...
        self.stamp_decimal_num_converted.SetToolTip( u"Децимальный номер автоматически корректируется\nсогласно ЕСКД.\nДанное значение будет указано в основной надписи\nперечня элементов." )
...
class SettingsDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.SetSizeHints( wx.Size( 600,450 ), wx.Size( -1,-1 ) )
        ...
        self.space_as_dot_checkbox.SetToolTip( u"Если этот параметр установлен, то в таблице и в полях ввода пробелы будут отображаться в виде специальных символов." )
        ...
        self.show_need_adjust_mark_checkbox.SetToolTip( u"Если этот параметр установлен, то на схеме, возле обозначения компонента, номинал которого \"Подбирают при регулировании\", будет отображаться метка \"*\"." )
        ...
        self.auto_groups_statictext.SetToolTip( u"Если элементам не назначено значие поля \"Группа\", то при загрузке элементов из файла схемы/библиотеки для выбранных типов они будут сформированны автоматически." )
        ...
        auto_groups_sizer.Add( ( 20, 0), 0, 0, 5 )
        ...
        separators_common_sizer.Add( ( 0, 0), 1, wx.EXPAND, 5 )
...
class SettingsSelector ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.checkbox_size_position.SetToolTip( u"Размер и положение окна программы на экране." )
        ...
        self.checkbox_column_sizes.SetToolTip( u"Размеры колонок таблицы элементов." )
        ...
        self.checkbox_comp_fields_panel.SetToolTip( u"Размеры панели полей выбранного компонента и его дочерних элементов." )
        ...
        self.checkbox_values.SetToolTip( u"Наборы часто используемых значений для разных полей элементов." )
        ...
        self.checkbox_auto_filling_groups.SetToolTip( u"Наборы значений и их состояние для\nавтоматического заполенения поля\n\"Группа\" при отрытии файлов схем и\nбиблиотек." )
        ...
        self.checkbox_aliases.SetToolTip( u"Псевдонимы позволяют использовать\nлюбые пользователские поля для \nработы с приложением." )
        ...
        self.checkbox_group_names.SetToolTip( u"Наименования групп в множественном и единственном числе." )
        ...
        self.checkbox_complist.SetToolTip( u"Параметры из диалогового окна\nсоздания перечня элементов." )
        ...
        self.checkbox_recent_sch.SetToolTip( u"Список недавно используемых файлов схем." )
        ...
        self.checkbox_recent_lib.SetToolTip( u"Список недавно используемых файлов схем." )
...
class EditAutoGroupsDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.param_statictext.SetToolTip( u"Одна или две буквы, с которых начинается обозначение элемента. Например, С для конденсаторов, D или DD для микросхем и т.д." )

        param_sizer.Add( self.param_statictext, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )


        param_sizer.Add( ( 0, 0), 1, 0, 5 )
        ...
        self.value_statictext.SetToolTip( u"Значение поля \"Группа\" которое будет установлено по умолчанию для указанных элементов." )
